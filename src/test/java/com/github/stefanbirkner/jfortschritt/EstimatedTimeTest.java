...
public class EstimatedTimeTest {
    ...
    private enum TestCase {
        ...
        elapsed_time_is_shown_if_finished(
            ARBITRARY_NUMBER_OF_STEPS, ARBITRARY_NUMBER_OF_STEPS, minutes(59) + seconds(59), "in 59m 59s");
    ...
    public void verifyTestCase(TestCase testCase) {
        EstimatedTimeWithControlledSystemTime estimatedTime = new EstimatedTimeWithControlledSystemTime();
    ...
    private static class EstimatedTimeWithControlledSystemTime extends EstimatedTime {
